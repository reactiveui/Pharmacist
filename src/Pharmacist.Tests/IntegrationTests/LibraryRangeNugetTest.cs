...
namespace Pharmacist.Tests.IntegrationTests
{
    ...
    {
        [Theory]
        [InlineData("Xamarin.Forms", "4.1.0.555618", "MonoAndroid81")]
        [InlineData("Xamarin.Forms", "4.1.0.555618", "MonoAndroid90")]
        [InlineData("Xamarin.Forms", "4.1.0.555618", "tizen40")]
        [InlineData("Xamarin.Forms", "4.1.0.555618", "uap10.0.17763")]
        [InlineData("Xamarin.Forms", "4.1.0.555618", "Xamarin.iOS10")]
        [InlineData("Xamarin.Forms", "4.1.0.555618", "Xamarin.Mac20")]
        [InlineData("Xamarin.Forms", "4.1.0.555618", "netstandard2.0")]
